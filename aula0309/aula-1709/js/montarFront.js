...
document.addEventListener("DOMContentLoaded", () => {
  ...
  elSelectFiltro.addEventListener('change', () => {
    ...
    // FAzer um if para ver qual o valor selecionado, só que já temos 
    // o TODOS, que retorna TODOS OS PRODUTOS, ele será o meu if, 
    // meu else será as outras categorias, para isso usaremos um filter()
    if (valor === 'todos') {
      exibirProdutos(produtos)
    } else {
